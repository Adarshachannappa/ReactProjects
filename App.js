...
const restaurantList = [
  {
    ...
    "data": {
      ...
      "slugs": {
        "restaurant": "srinidhi-veg-food-court-kalyan-nagar-kammanahallikalyan-nagar",
        "city": "bangalore"
      },
      "cityState": "1",
      "address": "#310,7TH MAIN ROAD,HRBR LAYOUT 1ST BLOCK,KALYANA NAGAR,BANGALORE-560043",
      "locality": "1st Block",
      "parentId": 20161,
      "unserviceable": false,
      "veg": true,
      ...
      "thirdPartyVendor": "",
      "adTrackingID": "cid=5933592~p=1~eid=00000186-6d23-a132-158d-e9fd00860102",
      "badges": {
        "imageBased": [
  ...
  },
  {
    ...
    "data": {
      ...
      "uuid": "26674516-8eeb-4435-abae-db2335b43ca4",
      "city": "1",
      "area": "Kalyan Nagar",
      "totalRatingsString": "1000+ ratings",
      ...
      "slugs": {
        "restaurant": "a2b-veg-opposite-to-bsnl-office-kammanahallikalyan-nagar",
        "city": "bangalore"
      },
      "cityState": "1",
      "address": "No 45,  Ramaiah Layout Kammanahalli Main road Opp to Charles School Bangalore - 560084",
      ...
      "thirdPartyAddress": false,
      "thirdPartyVendor": "",
      "adTrackingID": "cid=5958729~p=16~eid=00000186-6d23-a132-158d-ea020086104e",
      "badges": {
        "imageBased": [
  ...
  },
  {
    ...
    "data": {
      ...
      "slugs": {
        "restaurant": "sangam-mess-kammanahallikalyan-nagar-kammanahallikalyan-nagar",
        "city": "bangalore"
      },
      "cityState": "1",
      "address": "7 3rd Cross Chinnappa Layot Opp Sansar Collections Kammanahalli Main Road Bangalore 560084",
      ...
      "thirdPartyAddress": false,
      "thirdPartyVendor": "",
      "adTrackingID": "cid=5974729~p=7~eid=00000186-6d23-a132-158d-e9ff00860773",
      "badges": {
        "imageBased": [
  ...
  },
  {
    ...
    "data": {
      ...
      "cityState": "1",
      "address": "Udupi Upachar, Supradh building ,12 th main,3 rd cross road,coffee board layout,Hebbal kempapura,Bangalore:560024",
...
const RestaurantCard = ({name, cuisines, cloudinaryImageId, lastMileTravel}) =>{ 
  return (
    <div className="card">
      <img alt="card" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"
        + cloudinaryImageId} />
      <h2>{name}</h2>
      <h3>{cuisines.join(",")}</h3>
